...
>
> **Last updated:** > **Last updated:** 2026-06-02 (Brief 10 + Brief 10-supplement done — matching engine deployed with five-stage filter, per-stage missing-field guards (option ii), §0.3 doctrine added covering Airtable SDK wire behavior on Long Text fields. Brief 11 next.)
...
- _[next entry: after Brief 11 (scoring) is shipped]_
